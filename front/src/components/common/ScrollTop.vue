...
<style scoped>
#scroll-top { position: fixed; right: 2rem; bottom: 2rem; opacity: 1; transition: all .3s var(--easing-1) .3s; z-index: 10; }
...
#scroll-top button::before { position: absolute; left: 0; top: 0; content: ''; display: block; width: 100%; height: 100%; border-radius: 100%; background: #ff7061; transform: scale(0); transition: transform .3s var(--easing-1); }
